...
async def chatwoot_webhook(
    ...
    is_inquiry_selection = inquiry_selection is not None
    is_security_issue = should_handoff_security(user_content)
    is_complaint = should_handoff_complaint(user_content)
    if not is_inquiry_selection and (should_handoff_connection(user_content) or is_security_issue or is_complaint):
